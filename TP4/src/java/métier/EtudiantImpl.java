    ...
    public void modifierEtudiant(Etudiant etudiant) {
       cn =  cnObject.getConn();
        ...
        try {
            ...
            //i don't know why but if you executes multiple updates closing preperaed statement and connection invokes database errors meaning that it fails to update sometimes 
            //fo for now keep them off
            //ps.close();
            //cn.close();
